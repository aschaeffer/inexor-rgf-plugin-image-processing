...
use crate::behaviour::entity::entity_behaviour_provider::ImageProcessingEntityBehaviourProviderImpl;
...
use crate::provider::ImageProcessingEntityTypeProviderImpl;
use std::env;
...
#[async_trait]
pub trait ImageProcessingPlugin: Plugin + Send + Sync {}

#[module]
pub struct ImageProcessingPluginImpl {
    entity_type_provider: Wrc<ImageProcessingEntityTypeProviderImpl>,
    entity_behaviour_provider: Wrc<ImageProcessingEntityBehaviourProviderImpl>,

    context: PluginContextContainer,
}

impl ImageProcessingPluginImpl {}

interfaces!(ImageProcessingPluginImpl: dyn Plugin);

#[async_trait]
#[provides]
impl ImageProcessingPlugin for ImageProcessingPluginImpl {}

impl Plugin for ImageProcessingPluginImpl {
